  ...
  return (
    ...
    >
      ...
      <div className="flex items-start gap-12 px-[60px] mt-12 pb-20">
        {/* Left: profile photo in rounded rectangle with coral background */}
        <div
        ...
        <div className="flex flex-col gap-8 flex-1">
          ...
          <div className="flex gap-12">
            ...
            <div>
              ...
              <p className="font-[family-name:var(--font-noto)] text-black text-lg">Years Experience</p>
            </div>
          </div>
          ...
          <div>
            <p
              ...
              style={{ fontSize: "clamp(20px, 2.5vw, 36px)", color: "rgb(211,110,99)" }}
            >
              Hi, I am
            </p>
            <p
          ...
          {/* Description */}
          <p
            className="font-[family-name:var(--font-noto)] text-black max-w-prose"
          ...
          {/* Skills list */}
          <div>
            <p className="font-[family-name:var(--font-noto)] font-bold text-black text-lg mb-3">
              Core Skills
            </p>
